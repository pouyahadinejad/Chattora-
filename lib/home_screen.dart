...
import 'package:otpuivada/mobile_input_page.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  label: const Row(
    children: [
      Text('تسک جدید', style: TextStyle(fontFamily: 'Vazir',color: Colors.white,fontSize: 15),),
      SizedBox(width: 8),
        ...
        children: [
          ...
          onPressed: () async {
            ...
            Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (_) => OtpLoginPage()),
              (route) => false,
            );
          },
          ...
          hintText: 'جستجو در تسک‌ها...',hintStyle: TextStyle( fontFamily: 'Vazir',
