...
//   Timer? timer;
//   bool showLabel = true;
//   bool _termsAccepted = true; // چک باکس شرایط و قوانین
...
//     // اضافه کردن لیسنر برای ارسال خودکار کد
//     mobileController.addListener(() {
//       if (mobileController.text.length == 11 && _termsAccepted && !loading && timerSeconds == 0) {
//         sendOtp();
//       }
//     });
...
//     if (!_termsAccepted) {
//       _showSnackBar('لطفا شرایط و قوانین را بپذیرید');
//       return;
//     }
...
//               //     Expanded(
//               //       child: Text(
//               //         'با ارسال کد، شرایط و قوانین را می‌پذیرم',
//               //         style: TextStyle(
//               //           fontFamily: 'Kalameh',
//               //           fontSize: 12,
//               //         ),
